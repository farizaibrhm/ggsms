								...
								<div class="text-center mb-4" id="log_display"></div>
									<form action="" id="att-log-frm" >
										<div class="form-group">
											<label for="eno" class="control-label">Enter your password:</label>
											<input type="text" id="eno" name="eno" class="form-control col-sm-12">
										</div>
										<center>
											<button type="button" class='btn btn-sm btn-primary log_now col-sm-2' data-id="1">CLOCK IN</button>
											<button type="button" class='btn btn-sm btn-primary log_now col-sm-2' data-id="2">CLOCK OUT</button>
										</center>
